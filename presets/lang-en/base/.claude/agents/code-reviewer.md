...
Classify findings as `CRITICAL` / `WARNING` / `SUGGESTION`. If even one CRITICAL exists, recommend holding the merge. Back claims with file/line evidence, not speculation.
