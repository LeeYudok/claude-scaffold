...
> Follow global rules: issue-first, re-confirm the branch right before committing, GitLab 19 manual close.
...
> GitLab 19 does not auto-close the issue on MR merge → after merging, always run `glab issue note N` + `glab issue close N` manually.
